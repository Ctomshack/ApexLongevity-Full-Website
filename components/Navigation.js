      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex items-center justify-between border-b-2 border-blue-100 py-6 md:justify-start md:space-x-10">
          ...
          <div className="-my-2 -mr-2 md:hidden">
            ...
            <Popover.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 ring-2 ring-gray-300 hover:bg-gray-100 hover:text-apexG focus:outline-none focus:ring-2 focus:ring-inset focus:ring-apexG">
