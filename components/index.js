...
export { default as ContactUs } from './providers/ContactUs';
export { default as Content1 } from './providers/Content1';
export { default as ConvertPatients } from './providers/ConvertPatients';
export { default as Footer } from './providers/Footer';
export { default as Header } from './providers/Header';
export { default as Header2 } from './providers/Header2';
export { default as How } from './providers/How';
