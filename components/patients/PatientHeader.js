          ...
          <div className="w-full pt-16 pb-20 mx-auto text-center max-w-7xl lg:py-48 lg:text-left">
            <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
                <span className="block xl:inline">The Care You Need</span>{' '}
                <span className="block xl:inline">at a Cost You</span>{' '}
                <span className="block text-apexB xl:inline">Can Afford</span>{' '}
              </h1>
