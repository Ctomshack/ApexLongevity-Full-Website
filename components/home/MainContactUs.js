...
import SuccessMessage from "../providers/SuccessMessage";
      ...
      <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        <div className="px-4 py-16 bg-gray-50 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="max-w-lg mx-auto">
            <h2 className="text-2xl font-bold tracking-tight text-apexB sm:text-3xl">Get in touch</h2>
              ...
              <div className="mt-3">
                ...
                <dd className="flex">
                  <EnvelopeIcon
                    ...
                    aria-hidden="true"
                  />
                  <a href="mailto:support@apexlongevity.com "><span className="ml-3 hover:text-apexG">support@apexlongevity.com</span></a>
                </dd>
              </div>
            </dl>
          </div>
